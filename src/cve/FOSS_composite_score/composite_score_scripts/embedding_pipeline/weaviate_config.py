...
def define_weaviate_schema(client: weaviate.WeaviateClient) -> None:
    ...
    foss_wvc_collection = client.collections.create(
        ...
        vectorizer_config=[
            wvc_config.Configure.NamedVectors.none(name="ollama_nomic_name_vectors"),
            wvc_config.Configure.NamedVectors.none(name=""),
            wvc_config.Configure.NamedVectors.none(name="combined_vector")
        ],
        properties=[
