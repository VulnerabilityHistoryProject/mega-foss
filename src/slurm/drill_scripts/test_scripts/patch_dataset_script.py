...
# TODO add a constant string that points to the folder of cloned repos
# Assume that the clone repos have the folder structure of:
# nameoforg/nameofrepo or username/nameofrepo
...
# TODO - no need to clone and delete, just assume we have it
...
# TODO Structure it this way:
#  CVE-2008-1897/
#     771b3d8749b34b6eea4e03a2e514380da9582f90/
#         vulnerable_chan_iax2.c
#         fixed_chan_iax2.c
#         CVE-2008-1897_771b3d8749b34b6eea4e03a2e514380da9582f90.patch
#     a8b180875b037b8da26f6a3bcc8e5e98b8c904d2/
#   ...
